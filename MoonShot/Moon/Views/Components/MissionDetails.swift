...
struct MissionDetailsView_Previews: PreviewProvider {
    static let missions: [Mission] = ViewModel().missions
    static let astronauts: [String: Astronaut] = ViewModel().astronauts
    
    static var previews: some View {
        MissionDetails(mission: missions[0], astronauts: astronauts)
